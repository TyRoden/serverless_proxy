...
- Endpoint **Models** button returns `404`: some OpenAI/Codex OAuth tokens do not expose OpenAI-compatible `/models` routes. You can still save the endpoint and map known model IDs manually (for this setup, `gpt-5.4` is known to work).
